...
const ResumeLink = () => {
  return (
    ...
    >
      <h2 className="font-raleway text-4xl text-center">My Resume</h2>
      <p className="font-raleway text-2xl text-center">
        Click the link below to download my resume:
      </p>
      <a
        className="font-raleway text-4xl text-center hover:text-darkGray border border-dashed border-white p-3 rounded-md mt-4 hover:border-darkGray"
        href={`${process.env.PUBLIC_URL}files/MH-Coding-Resume.pdf`}
        target="_blank"
        download="MH-Coding-Resume.pdf"
      >
        Download Resume
      </a>
    </div>
