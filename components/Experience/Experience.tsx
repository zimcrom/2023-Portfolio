  ...
  return (
    ...
    >
      ...
      >
        ...
        {header1 && <h2 className={`font-raleway text-8xl ${textAlign}`} style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 1)' }}>{header1}</h2>}
        {header2 && <p className={`font-raleway text-2xl ${textAlign}`} style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 1)' }}>{header2}</p>}
 ...
 <div className="mx-auto grid max-w-5xl gap-12 py-12 lg:grid-cols-2">
          <div className="grid gap-6">
            <div className="grid gap-1">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                HTML5, CSS3, JavaScript, jQuery, Bootstrap, Materialize, Tailwind, React, Angular, TypeScript, NextJS
              </p>
            </div>
            <div className="grid gap-1">
              <h3 className="text-xl font-bold">Back-End Development</h3>
              <p className="text-gray-500 dark:text-gray-400">Node.js, Express, PHP, Java, Kotlin, C#, Python</p>
            </div>
            <div className="grid gap-1">
          ...
          <div className="grid gap-6">
            <div className="grid gap-1">
              ...
              <p className="text-gray-500 dark:text-gray-400">JavaScript, TypeScript, Java, Kotlin, C#, Python</p>
            </div>
            <div className="grid gap-1">
            ...
            <div className="grid gap-1">
              ...
              <p className="text-gray-500 dark:text-gray-400">Firebase, Netlify, Heroku</p>
            </div>
          </div>
        </div>
